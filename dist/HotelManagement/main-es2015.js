...
let HotelComponent = class HotelComponent {
    constructor(oHotelService, oToast) {
    ...
    addNewHotel(oForm) {
        this.oHotelService.addHotel(oForm.value).subscribe((data) => {
            if (data.success) {
    ...
    getHotelsList() {
        this.oHotelService.getHotelsList().subscribe((data) => {
            data.forEach(obj => obj.selector = false);
            this.oLstHotels = data;
        });
    }
    onChangeLocation(locationHotel) {
        this.oHotelService.searchForLocationHotel(locationHotel.value).subscribe((data) => {
            data.forEach(obj => obj.selector = false);
    ...
    updateHotel(updateForm, specificForm) {
        this.oHotelService.updateHotel(updateForm.value, specificForm, this.checkboxActive).subscribe((data) => {
            if (data.success) {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_3__["toast"])('Works fine', 3000);
            }
            else {
    ...
    changeStatusHotel(idHotel, availability) {
        ...
        this.oHotelService.changeStatusHotel(idHotel, newStatus).subscribe((data) => {
...
let PersonComponent = class PersonComponent {
    constructor(toastrService, oPersonService) {
        this.toastrService = toastrService;
        this.oPersonService = oPersonService;
    }
    ngOnInit() {
    }
    addNewPerson(personForm) {
        this.oPersonService.addPerson(personForm.value).subscribe((data) => {
    ...
    searchDocument(event) {
        this.oPersonService.searchForDocument(event.target.value).subscribe((data) => {
            if (data === true) {
                event.target.value = '';
    ...
    searchForEmailAvailability(event) {
        this.oPersonService.searchForEmailAvailability(event.target.value).subscribe((data) => {
            if (data === true) {
                event.target.value = '';
...
let ReservationComponent = class ReservationComponent {
    constructor(oHotelService, oPersonService, oRoomService, oReservationService) {
        this.oHotelService = oHotelService;
        this.oPersonService = oPersonService;
    ...
    getAllReservations() {
        this.oReservationService.getAllReservations().subscribe((data) => {
            data.forEach(obj => obj.selector = false);
    ...
    getReservationForHotelAndPerson() {
        if (this.oSearchHotel !== null || this.oSearchPerson !== null) {
            this.oReservationService.searchReservationsForPersonAndHotel(this.oSearchPerson, this.oSearchHotel).subscribe((data) => {
                data.forEach(obj => obj.selector = false);
                this.oLstReservations = data;
                console.log(data);
            });
    ...
    lookForRooms(IDHotel) {
        this.oRoomService.listRoomsByHotel(IDHotel.value).subscribe((data) => {
            data.forEach(obj => obj.selector = false);
            this.oLstRooms = data;
        });
    }
    ...
    searchDocument(event) {
        this.oPersonService.searchForPersonID(event.target.value).subscribe((data) => {
    ...
    addReservation(oForm) {
        this.oReservationService.addReservation(oForm.value, this.phonePersonReservation, this.oIdRoom).subscribe((data) => {
            if (data.personID !== null) {
    ...
    cancelReservation(idReservation) {
        this.oReservationService.cancelReservation(idReservation).subscribe((data) => {
...
let RoomComponent = class RoomComponent {
    constructor(oHotelService, oRoomService, toastrService) {
        this.oHotelService = oHotelService;
        this.oRoomService = oRoomService;
        this.toastrService = toastrService;
        this.modalActions1 = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    getRoomsList() {
        this.oRoomService.getListRooms().subscribe((data) => {
            data.forEach(obj => obj.selector = false);
            this.oLstRooms = data;
        });
    }
    ...
    addNewRoom(form) {
        this.oRoomService.addRoom(form.value, this.oTotalPrice).subscribe((data) => {
            if (data === true) {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_5__["toast"])('Works Fine', 3000);
            }
            else {
    ...
    changeStatusRoom(idRoom, availability) {
        const newStatus = availability.target.checked;
        this.checkboxActive = newStatus;
        this.oRoomService.changeStatusRoom(idRoom, newStatus).subscribe((data) => {
            if (data.idRoom != null) {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_5__["toast"])('Works fine', 3000);
            }
            else {
    ...
    searchForHotelPerHotel(oHotelID) {
        this.oRoomService.listRoomsByHotel(oHotelID.value).subscribe((data) => {
            data.forEach(obj => obj.selector = false);
            this.oLstRooms = data;
        });
    }
    updateRoom(updateForm, specificForm) {
        this.oRoomService.updateRoom(updateForm.value, specificForm, this.checkboxActive, this.uTotalPrice).subscribe((data) => {
            if (data.success) {
                Object(angular2_materialize__WEBPACK_IMPORTED_MODULE_5__["toast"])('Works fine', 3000);
            }
            else {
...
let HotelService = class HotelService {
    constructor(oHttpClient, urlRoute) {
    ...
    updateHotel(updateHotel, specificFile, availabilityHotel) {
...
let ReservationService = class ReservationService {
    ...
    addReservation(oReservation, phonePersonReservation, idRoom) {
...
let RoomService = class RoomService {
    ...
    updateRoom(roomUpdate, specificFile, availabilityRoom, totalPrice) {
